    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                fixed3 diffuse=_LightColor0.rgb*_Diffuse.rgb*albedo.rgb*saturate(dot(tangentLightDir,tangentNormal)*0.5+0.5);
